import { Middleware, MiddlewareAPI, Action as ReduxAction, Dispatch, Store } from 'redux';
import { History, Location as HistoryLocation } from 'history';

import { RouterConfig, parseLocation} from './location';
import { HistoryMethodCalledAction, HISTORY_METHOD_CALLED, changeLocation } from './actions';
